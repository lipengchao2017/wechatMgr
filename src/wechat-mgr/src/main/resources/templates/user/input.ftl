...
<form class="layui-form" id="saveForm" action="##" onsubmit="return false" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" id="usercode" name="usercode" lay-verify="required" placeholder="请输入用户编号[不可重复]" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item" hidden>
        <div class="layui-input-block">
            <button id="userSubmit" lay-filter="group" class="layui-btn" lay-submit lay-filter="*">立即提交</button>
            <button id="userReset" type="reset" class="layui-btn layui-btn-primary">重置</button>
        </div>
    </div>
</form>
